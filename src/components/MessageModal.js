...
export default function MessageModal({ isOpen, onClose }) {
  ...
  const groupNotifications = useCallback((notificationsData) => {
    ...
    notificationsData.forEach((notification, index) => {
      ...
      if (notification.displayName === currentUserName && nextNotification?.displayName === currentUserName) {
  ...
  const getNotificationMessage = (notification) => {
    const action = notification.type === 'like' ? (
